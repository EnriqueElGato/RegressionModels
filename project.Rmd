...
A pairs comparison of the variables in the dataset can be found (here) [TODO]. Some variable appear highly correlated with mpg.
...
A plot of the residuals for this model can be found (here)[TODO].
